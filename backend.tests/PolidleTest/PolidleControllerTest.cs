...
namespace backend.tests.PolidleTest // Eller backend.tests.Polidle.Controllers
{
    ...
    public class PolidleControllerTests
    {
        ...
        public async Task GetAllPoliticiansForGuessing_ReturnsOkWithListOfSearchListDto()
        {
            ...
            {
                new SearchListDto { Id = 1, PolitikerNavn = "Mette F", PictureUrl = "Img1"},
                new SearchListDto { Id = 2, PolitikerNavn = "Lars L", PictureUrl = "Img2"}
            };
            _serviceMock.GetAllPoliticiansForGuessingAsync().Returns(Task.FromResult(expectedPoliticians));
        ...
        {
            // Arrange
            var expectedDetails = new DailyPoliticianDto { Id = 1, Age = 40, PartyShortname = "TP", /* ... */ };
            _serviceMock.GetClassicDetailsOfTheDayAsync().Returns(Task.FromResult(expectedDetails));
        ...
        {
            // Arrange
            _serviceMock.GetClassicDetailsOfTheDayAsync().Returns(Task.FromResult<DailyPoliticianDto>(null));
        ...
        public async Task GetQuoteOfTheDay_ReturnsOkWithQuote_WhenExists()
        {
            ...
            _serviceMock.GetQuoteOfTheDayAsync().Returns(Task.FromResult(expectedQuote));
        ...
        public async Task GetPhotoOfTheDay_ReturnsOkWithPhoto_WhenExists()
        {
            ...
            _serviceMock.GetPhotoOfTheDayAsync().Returns(Task.FromResult(expectedPhoto));
        ...
        {
            // Arrange
            var guessRequest = new GuessRequestDto { GameMode = GamemodeTypes.Klassisk, GuessedPoliticianId = 2 };
            var expectedResult = new GuessResultDto { IsCorrectGuess = false, /* ... andre feedback felter ... */ };
            _serviceMock.ProcessGuessAsync(guessRequest)
        ...
        {
            // Arrange
            var guessRequest = new GuessRequestDto { GameMode = GamemodeTypes.Klassisk, GuessedPoliticianId = 3 };
            _serviceMock.ProcessGuessAsync(guessRequest)
