...
namespace backend.Migrations
{
    ...
    public partial class DenSidsteNadver : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    opdateringsdato = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    periodeid = table.Column<int>(type: "integer", nullable: false),
                    slutdato = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    startdato = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    ParliamentaryPositionsOfTrust = table.Column<List<string>>(
                        type: "text[]",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDateTimeUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    ...
                    LastScrapedUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey(
                        "PK_daily_selections",
                        x => new { x.selection_date, x.gamemode }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey(
                        "PK_GamemodeTrackers",
                        x => new { x.politiker_id, x.gamemode }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontImagePath = table.Column<string>(
                    ...
                    BackImagePath = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    100,
                    0,
                    "9a90d138-772e-44b1-b052-18d591edef58",
                    "superuser@borgertinget.dk",
                    true,
                    false,
                    null,
                    "SUPERUSER@BORGERTINGET.DK",
                    "BORGERTINGET_SUPERUSER",
                    "AQAAAAIAAYagAAAAEKkiDske0hqRbm0MzBQA++YPro6ISatyzOkYw3/ub4jrRtunkiomRLA2H3vP1i6E9A==",
                    null,
                    false,
                    "KIV5W5KJMIULHLFQ3YBIZNNU6AL2JBPH",
                    false,
                    "borgertinget_superuser",
                }
            );
            ...
            migrationBuilder.InsertData(
                ...
                {
                    2,
                    "Indhold for Den Politiske Akse...",
                    1,
                    1,
                    "Den Politiske Akse",
                }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    {
                        1,
                        new DateTime(2025, 4, 15, 10, 0, 0, 0, DateTimeKind.Utc),
                        null,
                        3,
                        "Hvad synes du om den nye bro?",
                    },
                    {
                        2,
                        new DateTime(2025, 4, 28, 14, 30, 0, 0, DateTimeKind.Utc),
                        null,
                        3,
                        "Skal Danmark øge investeringer i vedvarende energi?",
                    },
                }
            );
        ...
        {
            migrationBuilder.DropTable(name: "AnswerOptions");

            migrationBuilder.DropTable(name: "daily_selections");

            migrationBuilder.DropTable(name: "EventInterests");

            migrationBuilder.DropTable(name: "Flashcards");

            migrationBuilder.DropTable(name: "GamemodeTrackers");

            migrationBuilder.DropTable(name: "Party");

            migrationBuilder.DropTable(name: "PoliticianQuotes");
            ...
            migrationBuilder.DropTable(name: "UserVotes");
            ...
            migrationBuilder.DropTable(name: "PoliticianTwitterIds");

            migrationBuilder.DropTable(name: "Aktor");
        }
    }
}
