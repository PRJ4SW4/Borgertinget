...
// ... (dine imports af billeder forbliver de samme) ...
...
const TeamSection: React.FC<TeamSectionProps> = ({ id }) => {
  const teamDescription = `Vores team består af en række talentfulde og passioneret 
  software studerende som har påtaget sig opgaven at 
  bidrage til og uddanne den danske ungdom indenfor politik`;

  return (
    <section id={id} className={styles.teamSection}>
      <div className={styles.container}>
        {/* Wrapper til at styre side-om-side layoutet */}
